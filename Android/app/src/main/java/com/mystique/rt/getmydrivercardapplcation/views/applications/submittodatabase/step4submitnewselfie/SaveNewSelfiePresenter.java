...
public class SaveNewSelfiePresenter implements SaveNewSelfieContracts.Presenter {
    private final PictureService mPictureService;

    private final SchedulerProvider mSchedulerProvider;
    private SaveNewSelfieContracts.View mView;

    @Inject
    public SaveNewSelfiePresenter(PictureService pictureService, SchedulerProvider schedulerProvider) {
        mPictureService = pictureService;
        mSchedulerProvider = schedulerProvider;
    }

    @Override
    public void subscribe(SaveNewSelfieContracts.View view) {
        mView = view;
    }
