...
public class SaveOldCardPicPresenter implements SaveOldCardPicContracts.Presenter {
    private final PictureService mPictureService;

    private final SchedulerProvider mSchedulerProvider;
    private SaveOldCardPicContracts.View mView;

    @Inject
    public SaveOldCardPicPresenter(PictureService pictureService, SchedulerProvider schedulerProvider) {
        mPictureService = pictureService;
        mSchedulerProvider = schedulerProvider;
    }

    @Override
    public void subscribe(SaveOldCardPicContracts.View view) {
        mView = view;
    }
